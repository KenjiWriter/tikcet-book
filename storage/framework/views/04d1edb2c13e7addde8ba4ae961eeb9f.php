...
<?php echo app('flux')->scripts(); ?>
        ...
        <script>
            ...
            function loginWithApple() {
                window.location.href = '<?php echo e(route("auth.apple")); ?>';
            }

            function loginWithFacebook() {
                window.location.href = '<?php echo e(route("auth.facebook")); ?>';
            }

            function loginWithTwitter() {
                window.location.href = '<?php echo e(route("auth.twitter")); ?>';
            }

            function loginWithGitHub() {
                window.location.href = '<?php echo e(route("auth.github")); ?>';
            }
...
<?php /**PATH C:\xampp\htdocs\ticket-book\resources\views/components/layouts/auth/simple.blade.php ENDPATH**/ ?>